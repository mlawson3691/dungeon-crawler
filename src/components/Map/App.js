...
export default class Map extends Component {
  ...
  toggleSound(event) {
    ...
    if (current === 'PLAYING') {
      this.setState({musicPlayStatus: 'STOPPED', soundToggle: 'Music is OFF'});
    } else {
      this.setState({musicPlayStatus: 'PLAYING', soundToggle: 'Music is ON'});
    }
  }
  ...
  render() {
    return (
      <div>
        ...
        <Sound
          url='https://rawgit.com/mlawson3691/dungeon-crawler/master/public/sounds/song.mp3'
        ...
        <div id='toggleShadowBtn' onClick={this.toggleShadow.bind(this)}>Toggle Shadow</div>
